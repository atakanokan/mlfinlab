...
class ImbalanceBars(BaseBars):
    ...
    def __init__(self, file_path, metric, num_prev_bars=3, exp_num_ticks_init=100000, batch_size=1):
        """
        Constructor
...
if __name__ == "__main__":
    print("#################################\nTESTING IMBALANCE DATA STRUCTURES\n########################################")


    ### TICK IMBALANCE BARS
    bars = get_tick_imbalance_bars(file_path = './data/icm_mt5/EURUSD_ticks.csv', 
                                    num_prev_bars = 3, exp_num_ticks_init = 1000,
                                    batch_size=1, verbose=False, to_csv=False, output_path=None)
    print("\n\nTICK IMBALANCE BARS: \n{}".format(bars))

    ### VOLUME IMBALANCE BARS
    bars = get_volume_imbalance_bars(file_path = './data/icm_mt5/EURUSD_ticks.csv', 
                                    num_prev_bars = 3, exp_num_ticks_init = 1000,
                                    batch_size=1, verbose=False, to_csv=False, output_path=None)
    print("\n\nVOLUME IMBALANCE BARS: \n{}".format(bars))

    ### DOLLAR IMBALANCE BARS
    bars = get_dollar_imbalance_bars(file_path = './data/icm_mt5/EURUSD_ticks.csv', 
                                        num_prev_bars = 3, exp_num_ticks_init = 1000,
                                        batch_size=1, verbose=False, to_csv=False, output_path=None)
    print("\n\nDOLLAR IMBALANCE BARS: \n{}".format(bars))